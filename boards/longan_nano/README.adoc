...
rgb-neopixel-triple-ring-board-soft-blink:: A _{soft-blink}_ effect for an {NeoPixel-Triple-Ring-Board} with 44 RGB {NeoPixel}s using the the SPI MOSI pin, pin A7, of the Longan Nano.
